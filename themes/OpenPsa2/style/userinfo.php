...
{
    echo "<ul>\n";
    echo "    <li class=\"user\">" . midcom::auth->user->name . "</li>\n";
    echo "    <li class=\"logout\"><a href=\"" . midcom_connection::get_url('self') . "midcom-logout-\"><img src=\"" . MIDCOM_STATIC_URL . "/stock-icons/16x16/exit.png\" title=\"" . midcom::i18n()->get_string('logout', 'midcom') . "\" alt=\"" . midcom::i18n()->get_string('logout', 'midcom') . "\" /></a></li>\n";
