...
echo "<h2>";
echo midcom::i18n()->get_string('trash', 'midgard.admin.asgard');
echo "</h2>";
?>
...
<table class="deleted table_widget" id="deleted">
    <thead>
        <tr>
            <th><?php echo midcom::i18n()->get_string('type', 'midgard.admin.asgard'); ?></th>
            <th><?php echo midcom::i18n()->get_string('items in trash', 'midgard.admin.asgard'); ?></th>
        </tr>
    </thead>
    <tbody>
        <?php
