...
<div class="file-manager">
    <div class="filelist">
        ...
        if (count($data['files']) > 0)
        {
            ...
            echo "            <th>" . midcom::i18n()->get_string('revised on', 'midgard.admin.asgard') . "</th>\n";
            echo "            <th>" . midcom::i18n()->get_string('revised by', 'midgard.admin.asgard') . "</th>\n";
            echo "            <th>" . midcom::i18n()->get_string('size', 'midgard.admin.asgard') . "</th>\n";
            echo "            <th>" . midcom::i18n()->get_string('actions', 'midgard.admin.asgard') . "</th>\n";
            echo "        </tr>\n";
            echo "    </thead>\n";
            echo "    <tbody>\n";
            foreach ($data['files'] as $file)
            {
                ...
                {
                    $persons[$file->metadata->revisor] = midcom::auth->get_user($file->metadata->revisor);
                }
                ...
                $delete_title = sprintf(midcom::i18n()->get_string('delete %s %s', 'midgard.admin.asgard'), midcom::i18n()->get_string('attachment', 'midgard.admin.asgard'), $file->name);
                echo "<tr>\n";
                echo "  <td{$class}>\n";
                ...
                echo "    </a>\n";
                $manage_title = midcom::i18n()->get_string('manage object', 'midgard.admin.asgard');
        ...
        {
            echo "<p>" . midcom::i18n()->get_string('no files', 'midgard.admin.asgard') . "</p>\n";
        }
        ?>
    </div>
    <div class="main">
