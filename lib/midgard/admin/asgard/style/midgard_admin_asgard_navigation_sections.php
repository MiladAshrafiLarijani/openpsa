<form method="post" action="<?php echo midcom_connection::get_url('uri'); ?>" id="midgard_admin_asgard_navigation_form">
    ...
    <select name="midgard_type" id="midgard_admin_asgard_navigation_chooser">
        <option value=""><?php echo midcom::i18n()->get_string('midgard.admin.asgard', 'midgard.admin.asgard'); ?></option>
<?php
...
?>
    ...
    <input type="submit" name="midgard_type_change" class="submit" value="<?php echo midcom::i18n()->get_string('go', 'midgard.admin.asgard'); ?>" />
    </p>
</form>
