...
<div class="midgard_admin_asgard_components_component">
    <div class="maintainers">
        ...
        {
            echo "<h3>" . midcom::i18n()->get_string('created by', 'midgard.admin.asgard') . "</h3>\n";
            echo "<ul>\n";
    ...
    <div class="meta">
        ...
        {
            echo "<h2>" . midcom::i18n()->get_string('component depends on', 'midcom') . "</h2>\n";
            echo "<ul>\n";
            foreach ($data['component_dependencies'] as $dependency)
            {
                ...
                $component_icon = midcom::componentloader->get_component_icon($dependency);
                if (!$component_icon)
                {
    ...
    <div class="help">
        ...
        if (count($files) > 0)
        {
            echo "<h3>" . midcom::i18n()->get_string('component help', 'midcom.admin.help') . "</h3>\n";
            echo "<ul>\n";
