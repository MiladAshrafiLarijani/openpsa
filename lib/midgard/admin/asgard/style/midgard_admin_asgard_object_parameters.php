...
(
    ...
    (
        ...
        MIDCOM_TOOLBAR_LABEL => midcom::i18n()->get_string('add parameter', 'midgard.admin.asgard'),
...
if (count($data['parameters']) > 0)
{
    ...
    echo "    <thead>\n";
    echo "        <tr>\n";
    echo "            <th>" . midcom::i18n()->get_string('name', 'midcom') . "</th>\n";
    echo "            <th>" . midcom::i18n()->get_string('value', 'midcom') . "</th>\n";
    echo "            <th style=\"width: 80px;\">" . midcom::i18n()->get_string('actions', 'midcom') . "</th>\n";    
    echo "        </tr>\n";
    echo "    </thead>\n";
    echo "    <tbody>\n";
    $shown_domains = array();
