...
class midgard_admin_asgard_plugin extends midcom_baseclasses_components_handler
{
    ...
    function get_plugin_handlers()
    {
        ...
        midcom::auth->require_user_do('midgard.admin.asgard:access', null, 'midgard_admin_asgard_plugin');
        ...
        {
            midcom::i18n()->set_language($language);
        }
    ...
    static function prepare_plugin($title, &$data)
    {
        ...
        midcom::style->prepend_component_styledir(str_replace('asgard_','',$data['plugin_name']));
    }
    ...
    function bind_to_object($object, $handler_id, &$data)
    {
        ...
        midcom::set_26_request_metadata($object->metadata->revised, $object->guid);
        ...
        if (midcom::dbclassloader->is_midcom_db_object($object))
        {
            ...
            midcom::bind_view_to_object($object);
        ...
        switch ($handler_id)
        {
            case '____mfa-asgard-object_edit':
                $title_string = midcom::i18n()->get_string('edit %s %s', 'midgard.admin.asgard');
                break;
            case '____mfa-asgard-object_metadata':
                $title_string = midcom::i18n()->get_string('metadata of %s %s', 'midgard.admin.asgard');
                break;
            ...
            case '____mfa-asgard-object_attachments_delete':
                $title_string = midcom::i18n()->get_string('attachments of %s %s', 'midgard.admin.asgard');
                break;
            case '____mfa-asgard-object_parameters':
                $title_string = midcom::i18n()->get_string('parameters of %s %s', 'midgard.admin.asgard');
                break;
            case '____mfa-asgard-object_permissions':
                ...
                $title_string = sprintf(midcom::i18n()->get_string('permissions for %s %s', 'midgard.admin.asgard'), $type, midgard_admin_asgard_handler_object_permissions::resolve_object_title($this->_object));
                break;
            case '____mfa-asgard-object_create':
                $title_string = sprintf(midcom::i18n()->get_string('create %s under %s', 'midgard.admin.asgard'), midgard_admin_asgard_plugin::get_type_label($data['new_type_arg']), '%s %s');
                break;
            case '____mfa-asgard-object_delete':
                $title_string = midcom::i18n()->get_string('delete %s %s', 'midgard.admin.asgard');
                break;
            case '____mfa-asgard-object_rcs_history':
            case '____mfa-asgard-object_rcs_diff':
            case '____mfa-asgard-object_rcs_preview':
                $title_string = midcom::i18n()->get_string('revision history of %s %s', 'midgard.admin.asgard');
                break;
            default:
                $title_string = midcom::i18n()->get_string('%s %s', 'midgard.admin.asgard');
                break;
        }
    ...
    function get_object_toolbar($object, $handler_id, &$data)
    {
        ...
        {
            $link = midcom::permalinks->resolve_permalink($object->guid);
            if ($link)
            {
                $toolbar->add_item
                (
                    ...
                    (
                        ...
                        MIDCOM_TOOLBAR_LABEL => midcom::i18n()->get_string('view on site', 'midgard.admin.asgard'),
            ...
            if (midcom_helper_reflector_tree::get_child_objects($object))
            {
                ...
                (
                    ...
                    (
                        ...
                        MIDCOM_TOOLBAR_LABEL => midcom::i18n()->get_string('copy', 'midcom'),
        ...
        if ($object->can_do('midgard:update'))
        {
            ...
            (
                ...
                (
                    ...
                    MIDCOM_TOOLBAR_LABEL => midcom::i18n()->get_string('metadata', 'midcom'),
            ...
            (
                ...
                (
                    ...
                    MIDCOM_TOOLBAR_LABEL => midcom::i18n()->get_string('attachments', 'midgard.admin.asgard'),
            ...
            (
                ...
                (
                    ...
                    MIDCOM_TOOLBAR_LABEL => midcom::i18n()->get_string('parameters', 'midcom'),
            ...
            (
                ...
                (
                    ...
                    MIDCOM_TOOLBAR_LABEL => midcom::i18n()->get_string('privileges', 'midcom'),
            ...
            if (   midcom::componentloader->is_installed('midcom.helper.replicator')
                && midcom::auth->admin)
            {
                $toolbar->add_item
                (
                    ...
                    (
                        ...
                        MIDCOM_TOOLBAR_LABEL => midcom::i18n()->get_string('replication information', 'midcom.helper.replicator'),
            ...
            foreach ($child_types as $type)
            {
                ...
                if (is_a($object, 'midcom_db_topic'))
                {
                    ...
                    switch ($type)
                    {
                        ...
                        case 'midgard_article':
                            ...
                            break;
                        default:
                            $midcom_dba_classname = midcom::dbclassloader->get_midcom_class_name_for_mgdschema_object($type);
                            if (!$midcom_dba_classname)
                            {
                                $display_button = false;
                                break;
                            }
                            $component = midcom::dbclassloader->get_component_for_class($type);
                ...
                (
                    ...
                    (
                        ...
                        MIDCOM_TOOLBAR_LABEL => sprintf(midcom::i18n()->get_string('create %s', 'midcom'), midgard_admin_asgard_plugin::get_type_label($type)),
        ...
        if ($object->can_do('midgard:delete'))
        {
            ...
            (
                ...
                (
                    ...
                    MIDCOM_TOOLBAR_LABEL => midcom::i18n()->get_string('delete', 'midcom'),
            ...
            && $parent->guid)
        {
            ...
            (
                ...
                MIDCOM_NAV_NAME => midcom::i18n()->get_string('parameters', 'midcom'),
            );
        }
        ...
        switch ($handler_id)
        {
            ...
            case '____mfa-asgard-object_copy':
                ...
                (
                    ...
                    MIDCOM_NAV_NAME => midcom::i18n()->get_string('copy', 'midcom'),
                );
            ...
            case '____mfa-asgard-object_metadata':
                ...
                (
                    ...
                    MIDCOM_NAV_NAME => midcom::i18n()->get_string('metadata', 'midcom'),
                );
            ...
            case '____mfa-asgard-object_attachments_delete':
                ...
                (
                    ...
                    MIDCOM_NAV_NAME => midcom::i18n()->get_string('attachments', 'midgard.admin.asgard'),
                );
                ...
                if ($handler_id == '____mfa-asgard-object_attachments_delete')
                {
                    ...
                    (
                        ...
                        MIDCOM_NAV_NAME => midcom::i18n()->get_string('delete', 'midcom'),
                    );
                }
            ...
            case '____mfa-asgard-object_permissions':
                ...
                (
                    ...
                    MIDCOM_NAV_NAME => midcom::i18n()->get_string('privileges', 'midcom'),
                );
            ...
            case '____mfa-asgard-object_create':
                ...
                (
                    ...
                    MIDCOM_NAV_NAME => sprintf(midcom::i18n()->get_string('create %s', 'midcom'), midgard_admin_asgard_plugin::get_type_label($data['new_type_arg'])),
                );
            ...
            case '____mfa-asgard_midcom.helper.replicator-object':
                ...
                (
                    ...
                    MIDCOM_NAV_NAME => midcom::i18n()->get_string('replication information', 'midcom.helper.replicator'),
                );
    ...
    static function get_preference($preference)
    {
        ...
        if (!isset($preferences[$preference]))
        {
            ...
            if (!isset($preferences[midcom::auth->user->guid]))
            {
                $preferences[midcom::auth->user->guid] = new midcom_db_person(midcom::auth->user->guid);
            }

            $preferences[$preference] = $preferences[midcom::auth->user->guid]->get_parameter('midgard.admin.asgard:preferences', $preference);
        }
