...
jQuery("#&(grid_id);").jqGrid({
      ...
      colNames: ['id', 'index_number', <?php
                 echo '"' . midcom::i18n()->get_string('invoice number', 'org.openpsa.invoices') . '", "owner",';
                 echo '"index_date", "' . midcom::i18n()->get_string($data['date_field'], 'org.openpsa.invoices') . '",';
                 echo '"index_customer", "' . midcom::i18n()->get_string('customer', 'org.openpsa.invoices') . '",';
                 echo '"index_contact", "' . midcom::i18n()->get_string('customer contact', 'org.openpsa.invoices') . '",';
                 echo '"' . midcom::i18n()->get_string('sum excluding vat', 'org.openpsa.invoices') . '",';
                 echo '"index_vat", "' . midcom::i18n()->get_string('vat', 'org.openpsa.invoices') . '",';
                 echo '"' . midcom::i18n()->get_string('vat sum', 'org.openpsa.invoices') . '"';
      ?>],
      colModel:[
...
org_openpsa_export_csv.add({
      id: '&(grid_id);',
      fields: {
          index_number: '<?php echo midcom::i18n()->get_string('invoice number', 'org.openpsa.invoices'); ?>',
          owner: '<?php echo $data['l10n_midcom']->get('owner'); ?>',
          index_customer: '<?php echo midcom::i18n()->get_string('customer', 'org.openpsa.invoices'); ?>',
          index_contact: '<?php echo midcom::i18n()->get_string('customer contact', 'org.openpsa.invoices'); ?>',
          sum: '<?php echo midcom::i18n()->get_string('sum excluding vat', 'org.openpsa.invoices'); ?>',
          vat: '<?php echo midcom::i18n()->get_string('vat', 'org.openpsa.invoices'); ?>',
          vat_sum: '<?php echo midcom::i18n()->get_string('vat sum', 'org.openpsa.invoices'); ?>'
        }
});
