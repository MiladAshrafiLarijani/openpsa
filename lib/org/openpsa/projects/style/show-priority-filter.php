...
if ($data['view'] == 'grid')
{
    ...
    echo ' ' . midcom::i18n()->get_string('group by', 'org.openpsa.core') . ': ';
    ...
    echo '<option value="clear" ' . (($data['view_identifier'] == 'agreement') ? 'selected="selected"' : '' ) . ' >' . midcom::i18n()->get_string('no grouping', 'org.openpsa.core') . "</option>\n";
    echo '</select>';
} ?>
</div>