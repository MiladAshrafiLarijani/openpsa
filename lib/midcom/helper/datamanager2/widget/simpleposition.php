...
class midcom_helper_datamanager2_widget_simpleposition extends midcom_helper_datamanager2_widget
{
    ...
    function add_elements_to_form()
    {
        ...
        $this->_form->addElement('text', "{$this->name}_latitude", midcom::i18n()->get_string('latitude', 'org.routamc.positioning'), Array('class' => 'shorttext'));
        $this->_form->addElement('text', "{$this->name}_longitude", midcom::i18n()->get_string('longitude', 'org.routamc.positioning'), Array('class' => 'shorttext'));
