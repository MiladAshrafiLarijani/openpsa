...
else
{
    ...
    <form name="no_bergfald_rcs_history" action="" >
        <table>
            <thead>
                <tr>
                    <th><?php echo midcom::i18n()->get_string('revision', 'no.bergfald.rcs'); ?></th>
                    <th><?php echo midcom::i18n()->get_string('date', 'no.bergfald.rcs'); ?></th>
                    <th><?php echo midcom::i18n()->get_string('user', 'no.bergfald.rcs'); ?></th>
                    <th><?php echo midcom::i18n()->get_string('lines', 'no.bergfald.rcs'); ?></th>
                    <th><?php echo midcom::i18n()->get_string('message', 'no.bergfald.rcs'); ?></th>
                    <th></th>
                </tr>
            </thead>
            <tbody>
