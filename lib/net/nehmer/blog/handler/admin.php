...
class net_nehmer_blog_handler_admin extends midcom_baseclasses_components_handler
{
    ...
    function _process_link_delete()
    {
        ...
        {
            midcom::uimessages()->add($this->_l10n->get('net.nehmer.blog'), $this->_l10n->get('blog link deleted'));
            midcom::relocate('');
            // This will exit
        }
        else
        {
            midcom::generate_error(MIDCOM_ERRCRIT, $this->_l10n->get('failed to delete the blog link, contact the site administrator'));
            // This will exit
        }
    }
    ...
    function _handler_delete($handler_id, $args, &$data)
    {
        ...
        if (array_key_exists('net_nehmer_blog_deleteok', $_REQUEST))
        {
            ...
            midcom::uimessages()->add($this->_l10n->get('net.nehmer.blog'), sprintf($this->_l10n->get('article %s deleted'), $title));
