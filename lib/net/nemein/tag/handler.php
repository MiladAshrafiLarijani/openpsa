...
class net_nemein_tag_handler extends midcom_baseclasses_components_purecode
{
     ...
     * @param array $classes array of classes to search in
     * @param string $match string of 'AND' or 'OR', depending if you require all of the given tags on any of them, defaults to 'OR'
     * @param string $order string of 'ASC or 'DESC', to set the order of the returned list, defaults to 'ASC'
